...
public class QAClickAcademyTestNG {
WebDriver driver;
	@BeforeTest
	public void Setup() {
	...
	public void VerifyLinks() throws InterruptedException {
		...
		// Find number of links present under title "Discount Coupons" Also, click all
		// the links and verify their titles.
	...
	public void CheckTextbox() {
		// Check text box, list out auto suggestions and print in console, select text
	...
	@Test(priority = 5)
	public void dropdownKeyboard() {
		// Select From DropDown using KEYBOARD
		driver.findElement(By.name("dropdown-class-example")).sendKeys(Keys.ENTER, Keys.ARROW_DOWN, Keys.ARROW_DOWN,
				Keys.RETURN);
	 ...
	 * // Select From DropDown using MOUSE
	 * 
	 * driver.findElement(By.name("dropdown-class-example")).click(); Actions a =
	 * new Actions(driver); //not done
	 * 
	 * a.moveToElement(driver.findElement(By.name(
	 * "//select[@id='dropdown-class-example']/option[3]"))).click().build().perform
	 * (); WebElement move = driver.findElement(By.xpath(
	 * "//select[@id='dropdown-class-example']/option[3]"));
